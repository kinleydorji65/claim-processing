package com.claim.claim_processing.claim.service.application.impl;
...
import com.claim.claim_processing.claim.mapper.application.ClaimApplicationMapper;
...
public class ClaimApplicationServiceImpl implements ClaimApplicationService {
    ...
    private void applyCreateDefaults(
        ...
        entity.setRequiresManualReview(defaultFlag(request.getRequiresManualReview()));
        entity.setIsFinancialCase(defaultFlag(request.getIsFinancialCase()));
        entity.setIsPaymentRequired(defaultFlag(request.getIsPaymentRequired()));
        entity.setIsPostingRequired(defaultFlag(request.getIsPostingRequired()));
        entity.setRequiresManualApproval(defaultFlag(request.getRequiresManualApproval()));
    ...
    private String generateApplicationNumber(ClaimTypeMaster claimType) {
        ...
        String claimPrefix = getClaimTypePrefix(claimType.getCode());

        String baseApplicationNumber = "CLM-" + datePart + "-" + claimPrefix;
    ...
    private String getClaimTypePrefix(String claimTypeCode) {

        return switch (claimTypeCode) {
            case "NORMAL_CLAIM" -> "NOR";
            case "PARTIAL_WITHDRAWAL" -> "PAR";
            case "BENEFICIARY_SETTLEMENT" -> "BEN";
            case "EXCESS_REFUND" -> "EXR";
            case "WRONG_REMITTANCE" -> "WRR";
            case "LEGAL_RECOVERY" -> "LEG";
            case "SPECIAL_CASE" -> "SPC";
            default -> "GEN";
        };
    }
