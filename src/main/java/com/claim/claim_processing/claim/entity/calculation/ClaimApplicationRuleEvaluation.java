...
@Entity
@Table(
        name = "CLAIM_APPLICATION_RULE_EVALUATION",
...
public class ClaimApplicationRuleEvaluation {
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_CARE_CALC_SUMMARY")
    )
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_CARE_CLAIM_APP")
    )
    ...
    @JoinColumn(
            name = "RULE_TYPE_ID",
            foreignKey = @ForeignKey(name = "FK_CARE_RULE_TYPE")
    )
    private RuleTypeMaster ruleType;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(
            name = "EVALUATION_STAGE_ID",
            foreignKey = @ForeignKey(name = "FK_CARE_EVAL_STAGE")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CARE_EVAL_STATUS")
    )
