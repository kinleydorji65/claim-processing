...
public class LegalRecoveryDetail {
    ...
    @JoinColumn(
            ...
            nullable = false,
            unique = true,
            foreignKey = @ForeignKey(name = "FK_LRD_CLAIM_APP")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_LRD_RECOVERY_TYPE")
    )
    ...
    @JoinColumn(
            name = "SCHEME_TYPE_ID",
            foreignKey = @ForeignKey(name = "FK_LRD_SCHEME_TYPE")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_LRD_CURRENT_STATUS")
    )
    ...
    @JoinColumn(
            name = "LOAN_TYPE_ID",
            foreignKey = @ForeignKey(name = "FK_LRD_LOAN_TYPE")
    )
    ...
    @JoinColumn(
            name = "LOAN_STATUS_ID",
            foreignKey = @ForeignKey(name = "FK_LRD_LOAN_STATUS")
    )
