...
@Entity
@Table(
        name = "CLAIM_APPLICATION_PAYMENT",
...
public class ClaimApplicationPayment {
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_CAP_CLAIM_APP")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CAP_CALC_SUMMARY")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CAP_PAYMENT_STATUS")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CAP_PAYMENT_MODE")
    )
    ...
    @JoinColumn(
            name = "PAYEE_TYPE_ID",
            foreignKey = @ForeignKey(name = "FK_CAP_PAYEE_TYPE")
    )
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(
            name = "SELECTED_BANK_DETAIL_ID",
            foreignKey = @ForeignKey(name = "FK_CAP_BANK_DETAIL")
    )
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(
            name = "REVERSAL_STATUS_ID",
            foreignKey = @ForeignKey(name = "FK_CAP_REVERSAL_STATUS")
    )
