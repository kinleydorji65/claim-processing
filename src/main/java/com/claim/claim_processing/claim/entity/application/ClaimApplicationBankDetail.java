...
@Entity
@Table(
        name = "CLAIM_APPLICATION_BANK_DETAIL",
...
public class ClaimApplicationBankDetail {
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_CABD_CLAIM_APP")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CABD_CLAIMANT_TYPE")
    )
    ...
    @JoinColumn(
            name = "BANK_TYPE_ID",
            foreignKey = @ForeignKey(name = "FK_CABD_BANK_TYPE")
    )
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(
            name = "BANK_VERIFICATION_STATUS_ID",
            foreignKey = @ForeignKey(name = "FK_CABD_VER_STATUS")
    )
