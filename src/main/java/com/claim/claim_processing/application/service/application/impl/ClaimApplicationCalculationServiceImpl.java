...
public class ClaimApplicationCalculationServiceImpl implements ClaimApplicationCalculationService {
        ...
        private void storeClaimApplicationRuleEvaluation(ClaimApplicationCalculationSummary claimCalculationSummary,
                ...
                SubClaimMapping subRule = subClaimMappingRepository
                                .findFirstBySubClaimCodeIgnoreCase(calculationResponse.getSubClaimCode())
                                .orElseThrow(() -> ClaimException
                                                .notFound("Sub Claim Not found with sub claim code: "
                                                                + calculationResponse.getSubClaimCode()));
                ClaimApplicationRuleEvaluation ruleEvaluation = ClaimApplicationRuleEvaluation.builder()
                                ...
                                .isRuleApplied(claimCalculationSummary.getClaimApplication().getIsSpecialCase()
                                                .equals(ActivityEnum.Y)
                                                                ? ActivityEnum.N
                                                                : ActivityEnum.Y)
                                .resultMessage(claimCalculationSummary.getClaimApplication().getIsSpecialCase()
                                                .equals(ActivityEnum.Y)
        ...
        public ClaimApplicationCalculationSummary patch(ClaimApplicationCalculationPatchRequestDto request) {
                ...
                ClaimApplicationCalculationSummary summary = calculationSummaryRepository.findById(request.getCalculationSummaryId())
                                .orElseThrow(() -> new RuntimeException(
                                                "Calculation summary not found with id: " + request.getCalculationSummaryId()));
