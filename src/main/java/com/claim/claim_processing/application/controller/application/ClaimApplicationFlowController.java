...
public class ClaimApplicationFlowController {
        ...
        @GetMapping("/get-claim-application-by-agency-code")
        @Operation(summary = "Get claim applications by agency code and special case status")
        public ResponseEntity<ApiResponseDTO<List<GeneralClaimResponse>>> findByInitiatedByAndIsSpecialCase(
                        ...
                        @RequestParam(defaultValue = "N") ActivityEnum isSpecialCase,
                        @PageableDefault(size = 10, sort = {}) Pageable pageable) {

                return claimApplicationFlowService.findByInitiatedByAndIsSpecialCase(initiatedBy, isSpecialCase,
                                pageable);
        }
        ...
        public ResponseEntity<ApiResponseDTO<GeneralClaimResponse>> rejectbyVerifier(
                        @PathVariable String applicationNumber,
                        @RequestParam String rejectedBy, @RequestParam String remarks) {
                return ResponseEntity.ok(
                                claimApplicationFlowService.rejectedClaimApplication(applicationNumber, rejectedBy,
                                                remarks));
        }
        ...
        public ResponseEntity<ApiResponseDTO<GeneralClaimDetailResponse>> approveApproval(
                        @PathVariable String applicationNumber,
                        @RequestBody GeneralClaimApproverRequestDto request) {
                return ResponseEntity.ok(
        ...
        // public
        // ResponseEntity<ApiResponseDTO<ClaimApplicationVerificationResponseDto>>
        // patchVerification(
        // @PathVariable String applicationNumber,
        ...
        public ResponseEntity<ApiResponseDTO<GeneralClaimResponse>> verifyVerification(
                        @PathVariable String applicationNumber,
                        @RequestBody GeneralClaimApplicationVerifierRequestDTO request) {
                return ResponseEntity.ok(
        ...
        public ResponseEntity<ApiResponseDTO<ClaimApplicationVerificationResponseDto>> rejectedClaimApplication(
                        @PathVariable String applicationNumber, @RequestParam String rejectedBy,
                        @RequestParam String remarks) {
                return ResponseEntity.ok(
                                claimApplicationVerificationService.rejectedClaimApplication(applicationNumber,
                                                rejectedBy, remarks));
        }
        ...
        // public ResponseEntity<ApiResponseDTO<List<GeneralClaimResponse>>>
        // getAllVerifiedApplication() {
        // return ResponseEntity.ok(
        ...
        public ResponseEntity<ApiResponseDTO<List<GeneralClaimResponse>>> verifiedClaimApplicationClaimedBy(
                        ...
                        @RequestParam String claimedBy) {
                return ResponseEntity.ok(
                                claimApplicationFlowService.verifiedClaimApplicationClaimedBy(applicationNumber,
                                                claimedBy));
        }
        ...
        public ResponseEntity<ApiResponseDTO<List<GeneralClaimResponse>>> verifiedClaimApplicationUnClaimedBy(
                        ...
                        @RequestParam String unClaimedBy) {
                return ResponseEntity.ok(
                                claimApplicationFlowService.verifiedClaimApplicationUnClaimedBy(applicationNumber,
                                                unClaimedBy));
        }
        ...
        public ResponseEntity<ApiResponseDTO<ClaimApplicationApprovalResponseDto>> verifiedClaimActionClaimedBy(
                        ...
                        @RequestParam String claimedBy) {
                return ResponseEntity.ok(
                                claimApplicationApprovalService.verifiedClaimActionClaimedBy(applicationNumber,
                                                claimedBy));
        }
        ...
        public ResponseEntity<ApiResponseDTO<ClaimApplicationApprovalResponseDto>> verifiedClaimActionUnClaimedBy(
                        ...
                        @RequestParam String unClaimedBy) {
                return ResponseEntity.ok(
                                claimApplicationApprovalService.verifiedClaimActionUnClaimedBy(applicationNumber,
                                                unClaimedBy));
        }
        ...
        public ResponseEntity<ApiResponseDTO<GeneralClaimResponse>> verifiedClaimActionRejectedByApprover(
                ...
                return ResponseEntity.ok(
                                claimApplicationFlowService.verifiedClaimActionRejectedByApprover(applicationNumber,
                                                rejectedBy, rejectedRemarks));
        }
        ...
        public ResponseEntity<ApiResponseDTO<List<GeneralClaimResponse>>> getVerifiedClaimAndClaimedBy(
                        @PathVariable String claimedBy) {
                return ResponseEntity.ok(
        ...
        public ResponseEntity<ApiResponseDTO<List<GeneralClaimResponse>>> getVerifiedClaimWhichClaimedBy(
                        @PathVariable String claimedBy) {
                return ResponseEntity.ok(
