...
@Entity
@Table(
        name = "CLAIM_APPLICATION_DOCUMENT_DETAIL",
...
public class ClaimApplicationDocumentDetail {
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_CADD_CLAIM_APP")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CADD_DOC_TYPE")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CADD_DOC_CATEGORY")
    )
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "FK_CADD_VER_STATUS")
    )
